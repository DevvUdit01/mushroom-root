...
class _ProfileScreenState extends State<ProfileScreen> {
    ...
    try {
      ...
      if (picked != null) {
        ...
        if (partner != null) {
          ...
          if (res['success'] == true) {
            Get.snackbar('Photo Updated 📸', 'Your profile photo has been updated.',
      ...
      Get.snackbar('Upload Failed', e.toString().replaceFirst('Exception: ', ''),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Partner Account', style: TextStyle(fontWeight: FontWeight.bold)),
        elevation: 0,
      ),
      body: Obx(() {
        final partner = _auth.partner.value;
          ...
          child: Column(
            children: [
              ...
              Center(
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 16),
                    _buildKycStatusBadge(partner.kycStatus, partner.kycRejectionReason),
                  ],
                ),
              ),
              ...
              _buildDetailCard(
                ...
                children: [
                  _buildDetailRow(
                    ...
                    partner.dlNumber.isEmpty ? 'Not Provided' : partner.dlNumber,
                  ),
                  _buildDetailRow(
                    Icons.credit_card_outlined,
                    'Aadhar Number',
                    partner.aadharNumber.isEmpty ? 'Not Provided' : partner.aadharNumber,
                  ),
                ],
              ),
              const SizedBox(height: 16),
              ...
              _buildDetailCard(
                ...
                children: [
                  _buildDetailRow(Icons.directions_bike_rounded, 'Vehicle Category', partner.vehicleType.toUpperCase()),
                  _buildDetailRow(Icons.pin_outlined, 'License Plate / Number', partner.vehicleNumber.isEmpty ? 'Not entered' : partner.vehicleNumber),
                ],
              ),
              const SizedBox(height: 20),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(value, style: TextStyle(color: AppTheme.textColor, fontSize: 18, fontWeight: FontWeight.bold)),
          const SizedBox(height: 4),
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                label,
                style: TextStyle(color: fg, fontWeight: FontWeight.bold, fontSize: 12, letterSpacing: 0.5),
              ),
            ],
          ),
        ),
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(val, style: TextStyle(color: AppTheme.textColor, fontSize: 13, fontWeight: FontWeight.w600)),
            ],
          ),
        ),
      ],
  ...
  Widget _buildMenuCard(List<Widget> children) {
    return Container(
      ...
      child: Column(
        children: children.expand((w) => [w, const Divider(height: 1, color: AppTheme.border)]).toList()..removeLast(),
      ),
    );
  }
  ...
  void _showLogoutDialog() {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text('Are you sure you want to logout from your delivery partner account?',
