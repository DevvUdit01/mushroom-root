...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  Future<void> _pickPhoto() async {
    ...
    try {
      ...
      Get.snackbar('Photo Selection Failed', e.toString(),
  ...
  Future<void> _saveProfile() async {
    ...
    try {
      ...
      final res = await ApiService.updateProfile(
        ...
        email: partner?.email ?? '', // Preserve email in backend if already exists
      ...
      if (res['success'] == true) {
        Get.snackbar('Profile Saved ✅', 'Your details have been updated successfully.',
                  ...
                  children: [
                    DropdownButtonFormField<String>(
                      ...
                      decoration: InputDecoration(
                        ...
                        labelStyle: TextStyle(color: AppTheme.textMuted),
                        prefixIcon: const Icon(Icons.directions_bike_rounded, color: AppTheme.primary),
                        enabledBorder: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(12),
                          borderSide: BorderSide(color: AppTheme.border),
                        ),
                      ...
                      items: _vehicleTypes.map((type) {
                        return DropdownMenuItem<String>(
                          value: type,
                          child: Text(type.toUpperCase(), style: TextStyle(color: AppTheme.textColor)),
                        );
                      }).toList(),
                      onChanged: (val) {
