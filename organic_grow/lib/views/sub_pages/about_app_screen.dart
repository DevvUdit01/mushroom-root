      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 24),
            Text('RiFresh Odisha', style: AppTypography.h2.copyWith(fontWeight: FontWeight.bold, color: AppColor.textColor)),
            const SizedBox(height: 8),
            Text('Version 1.0.0 (Build #2026)', style: AppTypography.caption.copyWith(color: AppColor.textColor.withOpacity(0.4))),
            const SizedBox(height: 32),
            Text(
              'RiFresh Odisha is built to deliver clean, pesticide-free, premium organic produce directly from sustainable local farms to healthy households. We are proud to support local agriculture and environmentally conscious farming practices.',
              textAlign: TextAlign.center,
              style: AppTypography.bodyMedium.copyWith(color: AppColor.textColor.withOpacity(0.6), height: 1.6),
            ),
            const SizedBox(height: 48),
            Text('© 2026 RiFresh Odisha Inc.', style: AppTypography.caption.copyWith(color: AppColor.textColor.withOpacity(0.3))),
